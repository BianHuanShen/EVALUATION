...
{
    pregunta: "¿Cuál es el resultado de 327 + 154?",
    opciones: [
        "471",
        "481",
        "491",
...
{
    pregunta: "¿Cuál es el resultado de 725 - 318?",
    opciones: [
        "397",
        "407",
        "417",
...
{
    pregunta: "Una biblioteca tiene 245 libros y recibe 125 libros nuevos. ¿Cuántos libros tiene ahora?",
    opciones: [
        "360",
        "370",
        "380",
...
{
    pregunta: "Pedro tenía 500 pesos y gastó 175 pesos. ¿Cuánto dinero le quedó?",
    opciones: [
        "315 pesos",
        "325 pesos",
        "335 pesos",
...
{
    pregunta: "Hay 6 cajas y en cada caja hay 5 colores. ¿Cuántos colores hay en total?",
    opciones: [
        "25",
        "30",
        "35",
...
{
    pregunta: "Una profesora tiene 36 lápices y quiere repartirlos por igual entre 4 estudiantes. ¿Cuántos lápices recibe cada estudiante?",
    opciones: [
        "7",
        "8",
        "9",
...
{
    pregunta: "¿Cuál es el resultado de 456 + 237?",
    opciones: [
        "683",
        "693",
        "703",
...
{
    pregunta: "¿Cuál es el resultado de 900 - 456?",
    opciones: [
        "434",
        "444",
        "454",
...
{
    pregunta: "¿Cuál es el número que falta? 125, 126, 127, ___, 129",
    opciones: [
        "126",
        "127",
        "128",
...
{
    pregunta: "Laura tiene 235 stickers y su amiga le regala 146 más. ¿Cuántos stickers tiene ahora?",
    opciones: [
        "371",
        "381",
        "391",
...
{
    pregunta: "En una granja había 650 gallinas. Se fueron 225. ¿Cuántas gallinas quedaron?",
    opciones: [
        "415",
        "425",
        "435",
...
{
    pregunta: "Hay 7 bolsas con 6 naranjas en cada una. ¿Cuántas naranjas hay en total?",
    opciones: [
        "36",
        "40",
        "42",
...
{
    pregunta: "Una profesora tiene 45 colores y los reparte por igual entre 5 niños. ¿Cuántos colores recibe cada niño?",
    opciones: [
        "7",
        "8",
        "9",
