...
const BANCO_PREGUNTAS = [
    ...
    {
        pregunta: "¿Por qué es importante hacer actividad física?",
        opciones: [
            "Porque ayuda a mantener nuestro cuerpo saludable",
            "Porque nos hace dormir todo el día",
            "Porque evita que aprendamos",
            "Porque nos impide jugar"
        ],
        correcta: 0
    },

    {
        pregunta: "¿Qué debemos hacer antes de realizar ejercicio?",
        opciones: [
            "Acostarnos a dormir",
    ...
    {
        pregunta: "¿Cuál de estas actividades ayuda a mejorar la resistencia?",
        opciones: [
            "Correr",
            "Dormir",
            "Estar sentado",
    ...
    {
        pregunta: "¿Qué parte del cuerpo usamos principalmente para correr?",
        opciones: [
            "Las piernas",
            "Las orejas",
            "El cabello",
    ...
    {
        pregunta: "¿Qué debemos hacer después de realizar mucho ejercicio?",
        opciones: [
            "Descansar y tomar agua",
            "Correr más sin parar",
            "No respirar",
    ...
    {
        pregunta: "¿Cuál de estos es un ejercicio físico?",
        opciones: [
            "Saltar",
            "Dormir",
            "Ver una película",
    ...
    {
        pregunta: "¿Qué nos ayuda a mantener el equilibrio?",
        opciones: [
            "Controlar nuestro cuerpo",
            "Cerrar los ojos siempre",
            "Correr sin mirar",
            "Quedarnos dormidos"
        ],
        correcta: 0
    ...
    {
        pregunta: "¿Cuál de estas actividades trabaja la coordinación?",
        opciones: [
    ...
    {
        pregunta: "¿Qué debemos hacer cuando jugamos con nuestros compañeros?",
        opciones: [
            "Respetar las reglas",
            "Hacer trampa",
            "Empujar a los demás",
            "Enojarnos si perdemos"
        ],
        correcta: 0
    },

    {
        pregunta: "¿Cuál es un buen hábito para cuidar nuestro cuerpo?",
        opciones: [
            "Hacer ejercicio y alimentarnos bien",
            "No tomar agua",
            "Dormir muy poco",
            "Comer solamente golosinas"
        ],
        correcta: 0
    },

    {
        pregunta: "¿Qué debemos beber durante o después de hacer ejercicio?",
        opciones: [
            "Agua",
            "Pintura",
            "Aceite",
...

    {
        ...
        opciones: [
            "Ayudarnos y colaborar con los demás",
            "Jugar siempre solos",
            "No escuchar a nadie",
    ...
    {
        pregunta: "¿Cuál de estos movimientos consiste en despegar los pies del suelo?",
        opciones: [
            "Saltar",
            "Caminar",
            "Sentarse",
    ...
    {
        pregunta: "¿Cuál de estas actividades ayuda a mejorar la flexibilidad?",
        opciones: [
            "Estirar el cuerpo",
            "Dormir",
            "Ver televisión",
    ...
    {
        pregunta: "¿Qué debemos hacer si estamos muy cansados durante un ejercicio?",
        opciones: [
            "Descansar y avisar al profesor",
            "Seguir aunque nos duela mucho",
    ...
    {
        pregunta: "¿Cuál es una forma correcta de correr?",
        opciones: [
            "Mirar hacia adelante y controlar nuestros movimientos",
            "Correr empujando a los demás",
            "Correr con los ojos cerrados",
            "Correr sin prestar atención"
        ],
        correcta: 0
    },

    {
        pregunta: "¿Qué capacidad usamos cuando corremos durante varios minutos?",
        opciones: [
            "Resistencia",
            "Sueño",
            "Hambre",
    ...
    {
        pregunta: "¿Qué podemos mejorar al practicar juegos con pelota?",
        opciones: [
            "La coordinación",
            "El sueño",
            "La lectura",
    ...
    {
        pregunta: "¿Qué debemos hacer para evitar accidentes durante una actividad física?",
        opciones: [
            "Seguir las instrucciones y tener cuidado",
            "Correr sin mirar",
    ...
    {
        pregunta: "¿Por qué debemos respetar a nuestros compañeros durante los juegos?",
        opciones: [
            "Porque todos merecemos un buen trato",
            "Porque así podemos hacer trampa",
            "Porque podemos empujarlos",
            "Porque debemos ganar siempre"
        ],
        correcta: 0
    },

    {
        pregunta: "¿Cuál de estos juegos puede ayudar a desarrollar la velocidad?",
        opciones: [
            "Las carreras",
            "Los rompecabezas",
            "La lectura",
    ...
    {
        pregunta: "¿Qué debemos hacer cuando escuchamos la señal del profesor?",
        opciones: [
            "Prestar atención y seguir la indicación",
            "Seguir jugando sin escuchar",
            "Salir corriendo",
            "Ignorarla"
        ],
        correcta: 0
    ...
    {
        pregunta: "¿Cuál de estas acciones ayuda a cuidar nuestros músculos?",
        opciones: [
    ...
    {
        pregunta: "¿Qué podemos hacer para mejorar nuestro equilibrio?",
        opciones: [
    ...
    {
        pregunta: "¿Qué debemos hacer con los implementos deportivos después de usarlos?",
        opciones: [
    ...
    {
        pregunta: "¿Cuál de estas actividades requiere coordinación entre las manos y los ojos?",
        opciones: [
            "Atrapar una pelota",
            "Dormir",
            "Caminar lentamente",
    ...
    {
        pregunta: "¿Qué es importante hacer cuando comienza una clase de Educación Física?",
        opciones: [
    ...
    {
        pregunta: "¿Qué debemos usar para proteger nuestros pies durante la clase?",
        opciones: [
            "Zapatos deportivos adecuados",
            "Medias solamente",
            "Zapatos muy grandes",
            "Estar descalzos siempre"
        ],
        correcta: 0
    },

    {
        pregunta: "¿Cuál de estos movimientos consiste en desplazarse apoyando un pie y luego el otro?",
        opciones: [
            "Caminar",
            "Saltar",
            "Girar",
    ...
    {
        pregunta: "¿Qué debemos hacer si un compañero se cae durante un juego?",
        opciones: [
            "Ayudarlo y avisar al profesor",
            "Reírnos de él",
            "Seguir jugando sin importar",
    ...
    {
        pregunta: "¿Qué actividad ayuda a fortalecer las piernas?",
        opciones: [
            "Saltar",
            "Dormir",
            "Leer",
    ...
    {
        pregunta: "¿Qué debemos hacer para cuidar nuestra higiene después de hacer ejercicio?",
        opciones: [
            "Bañarnos y cambiarnos de ropa",
            "No limpiarnos",
            "Usar la misma ropa muchos días",
    ...
    {
        pregunta: "¿Cuál de estas actividades necesita que usemos nuestros brazos para lanzar?",
        opciones: [
            "Lanzar una pelota",
            "Dormir",
            "Caminar",
    ...
    {
        pregunta: "¿Qué actitud debemos tener cuando ganamos un juego?",
        opciones: [
    ...
    {
        pregunta: "¿Qué actitud debemos tener cuando perdemos un juego?",
        opciones: [
            "Aceptar el resultado y seguir aprendiendo",
            "Enojarnos con todos",
            "Hacer trampa",
            "Insultar al ganador"
        ],
    ...
    {
        pregunta: "¿Cuál es una actividad que podemos realizar al aire libre?",
        opciones: [
            "Jugar fútbol",
            "Dormir en clase",
            "Ver televisión",
    ...
    {
        pregunta: "¿Qué ayuda a nuestro cuerpo a recuperar energía después del ejercicio?",
        opciones: [
            "Descansar y alimentarnos adecuadamente",
            "No dormir",
            "No tomar agua",
            "Seguir haciendo ejercicio sin parar"
        ],
        correcta: 0
    },

    {
        pregunta: "¿Qué debemos hacer antes de comenzar una carrera?",
        opciones: [
            "Prepararnos y escuchar las instrucciones",
            "Empujar a los demás",
            "Salir antes de la señal",
            "Cerrar los ojos"
        ],
        correcta: 0
    },
    ...
    {
        pregunta: "¿Cuál de estas acciones demuestra respeto durante un juego?",
        opciones: [
            "Esperar nuestro turno",
            "Quitarle el balón a un compañero con violencia",
            "Hacer trampa",
            "Insultar"
        ],
        correcta: 0
    ...
    {
        pregunta: "¿Por qué es bueno practicar diferentes actividades físicas?",
        opciones: [
            "Porque ayudan a mantener nuestro cuerpo activo y saludable",
            "Porque nos impiden descansar",
            "Porque debemos ganar siempre",
            "Porque no necesitamos alimentarnos"
        ],
        correcta: 0
    }
