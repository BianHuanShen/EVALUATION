...

{
    ...
    opciones: [
        ...
        "Para escribir e introducir información",
...

{
    ...
    opciones: [
        "Para mover el puntero y seleccionar elementos",
        "Para imprimir documentos",
        "Para escuchar sonidos",
        "Para guardar archivos físicamente"
    ],
    correcta: 0
},

{
    pregunta: "¿Cuál de los siguientes elementos es hardware?",
    opciones: [
        "Windows",
        "Un videojuego",
        "El teclado",
...
{
    pregunta: "¿Cuál de los siguientes es un ejemplo de software?",
    opciones: [
        "Monitor",
        "Mouse",
        "Teclado",
...

{
    ...
    opciones: [
        "Una memoria que ayuda al computador a trabajar temporalmente con información",
        "Un tipo de mouse",
        "Una pantalla",
        "Un teclado especial"
    ],
...
{
    pregunta: "¿Para qué sirve el monitor?",
    opciones: [
        "Para escribir",
        "Para mover el puntero",
        "Para mostrar imágenes e información",
...
{
    pregunta: "¿Qué dispositivo permite escuchar sonidos del computador?",
    opciones: [
        "Teclado",
        "Parlantes",
        "Mouse",
...
{
    pregunta: "¿Cuál de estos grupos contiene solamente elementos de hardware?",
    opciones: [
        "Teclado, mouse y monitor",
        "Windows, Word y Paint",
        "Internet, Windows y un juego",
        "Aplicación, programa y videojuego"
    ],
    correcta: 0
}
