...
const BANCO_PREGUNTAS = [
    ...
    {
    pregunta: "Lee: 'Camila encontró un pequeño cachorro cerca de su casa. Como estaba solo, decidió llevarlo a un lugar seguro y buscar a su dueño.' ¿Qué encontró Camila?",
    opciones: [
        "Un gato",
        "Un cachorro",
        "Un pájaro",
...
{
    pregunta: "Según la lectura, ¿dónde encontró Camila al cachorro?",
    opciones: [
        "En la escuela",
        "En el parque",
        "Cerca de su casa",
...
{
    pregunta: "¿Qué decidió hacer Camila con el cachorro?",
    opciones: [
        "Dejarlo solo",
        "Llevarlo a un lugar seguro",
        "Regalarlo inmediatamente",
...
{
    pregunta: "¿Por qué Camila buscó al dueño del cachorro?",
    opciones: [
        "Porque quería venderlo",
        "Porque el cachorro estaba perdido",
...
{
    pregunta: "¿Cuál sería un buen título para la historia?",
    opciones: [
        "Camila y el cachorro perdido",
...
{
    pregunta: "¿Cuál es la idea principal de la historia?",
    opciones: [
        "Camila ayudó a un cachorro que estaba solo",
        "Camila quería comprar un animal",
        "El cachorro vivía con Camila",
        "Camila fue de paseo"
    ],
    correcta: 0
},
...
{
    pregunta: "Lee: 'Tomás llevó su paraguas porque el cielo estaba oscuro y comenzaba a llover.' ¿Por qué llevó el paraguas?",
    opciones: [
        "Porque hacía mucho sol",
        "Porque comenzaba a llover",
        "Porque iba a jugar",
...
{
    pregunta: "¿Qué podemos entender cuando una persona ayuda a alguien que lo necesita?",
    opciones: [
        "Que está siendo amable",
        "Que está enojada",
...
{
    pregunta: "¿Qué debería hacer un niño si no comprende una parte de una lectura?",
    opciones: [
        "Dejar de leer inmediatamente",
        "Leer nuevamente y preguntar si es necesario",
...
{
    pregunta: "¿Qué podemos encontrar normalmente en una historia?",
    opciones: [
